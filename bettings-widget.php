 ...
 * Plugin URI: https://bettin.gs/about
...
class Bettings_Widget extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'bettings-widget', __('Bettin.gs Widget', 'bettings'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		if ( $alias ) {
			$ch = curl_init();
			curl_setopt($ch, CURLOPT_URL, 'https://bettin.gs/api/alltimestats/'.$alias);
		...
		if ( $show_link )
			printf( '<p>Full stats &rarr; <a href="https://bettin.gs/'.$alias.'">Bettin.gs/'.$alias.'</a></p>', 'bettings' );
